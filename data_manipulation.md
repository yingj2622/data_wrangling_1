...
Filter is intended to remove or keep rows. TRUE -\> keep, FALSE -\>
remove
...
If you out more than one column into arrange function, it’ll arrange the
1st column, and then arrange the 2nd, …
